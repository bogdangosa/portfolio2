  ...
  return (
    <div className="Home">
        ...
        <div className="HomeProjectsSection">
            ...
            <HomeProjectCard attributes={new Array("HTML","CSS","JavaScript","GSAP")} onClick={()=>openInNewTab("https://sindhusaraswathybhaskaran.com/")} reversed={true} image="/project_images/sindu.png" title="Unmeelana">I developed a presentational website for an artist.Here i had to create some custom animations using GSAP. It’s a simple and artistic project.</HomeProjectCard>
